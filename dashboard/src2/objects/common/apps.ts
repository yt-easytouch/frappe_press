...
const siteAppListOptions: Partial<TabList> = {
	...
	banner({ documentResource: site }) {
		const bannerTitle =
			'Your site is currently on a shared bench group. Upgrade plan to install custom apps, enable server scripts and <a href="https://easytouch.cloud/shared-hosting#benches" class="underline" target="_blank">more</a>.';
