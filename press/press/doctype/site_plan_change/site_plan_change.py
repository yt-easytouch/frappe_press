...
class SitePlanChange(Document):
	...
	def validate(self):
		...
		if (
			...
			frappe.throw(
				f"Sorry, you cannot downgrade to {self.to_plan} from {self.from_plan}. <a href='https://easytouch.cloud/docs/tiny-plan#why-cant-i-upgrade-to-this-plan-'><u>Why?</u></a>"
			)
